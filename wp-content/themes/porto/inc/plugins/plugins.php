...
if ( ( current_user_can( 'manage_options' ) && wp_doing_ajax() ) || ( is_admin() && ! is_customize_preview() ) ) {
	class PortoTGMPlugins {
		...
		protected $plugins = [array(
			...
			'image_url' => PORTO_PLUGINS_URI . '/images/alpus-aprs.png',
			'source'=> PORTO_URI . '/plugins/alpus-aprs.zip',
			),
			array(
			...
			'image_url'=> PORTO_PLUGINS_URI . '/images/alpus-flexbox.png',
			'source'=> PORTO_URI . '/plugins/alpus-flexbox.zip',
			),
			array(
			...
			'image_url'=> PORTO_PLUGINS_URI . '/images/porto_vc_addon.png',
			'source'=> PORTO_URI . '/plugins/porto-vc-addon.zip',
			),
			array(		
			array(
				'name'      => 'Elementor',
