...
'image_url' => get_template_directory_uri() . '/inc/plugins/images/alpus-aprs.png'
],
[
...
'image_url' => get_template_directory_uri() . '/inc/plugins/images/alpus-flexbox.png'
],
[
'name'=> 'Porto Theme - Visual Composer Addon',
'slug'=> 'porto-vc-addon',
'required'=> false,
'url'=> 'porto-vc-addon/init.php',
'image_url' => get_template_directory_uri() . '/inc/plugins/images/porto_vc_addon.png'
]
] )
];
 ...
 * Define variables
 */
define('PORTO_DIR', get_parent_theme_file_path());
...
define( 'PORTO_WC_103_PREFIX', defined( 'WC_VERSION' ) && version_compare( WC_VERSION, '10.3.0', '>=') ? 'wc-' : '' );
